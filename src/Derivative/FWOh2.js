...
class FWh2 extends Component {
  ...
  fw2(h, x) {
    this.y = (-(this.fx(x+h*2))+(4*this.fx(x+h))-(3*this.fx(x)))/(2*h);
      ...
      <div className="has-text-centered">
        <section class="hero is-danger">
          <div className="container">
            <form>
              <h1 className="title">FW O(h<sup>2</sup>)</h1><br/>
              ...
              <Button ghost onClick={() => this.fw2(parseFloat(this.state.h), parseFloat(this.state.x))}>Submit</Button>
            </form>
            <br/><br/>
                    {this.state.showH && 
