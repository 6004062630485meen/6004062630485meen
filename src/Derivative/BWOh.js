...
class BWh extends Component {
  ...
  bw(h, x) {
    this.y = (this.fx(x)-this.fx(x-h))/h;
      ...
      <div className="has-text-centered">
        <section class="hero is-danger">
          <div style={{ padding: 24, minHeight: 360, overflowX: 'auto' }}>
            <form>
              <h1 className="title">BW O(h)</h1><br/>
              ...
              <Button ghost onClick={() => this.bw(parseFloat(this.state.h), parseFloat(this.state.x))}>Submit</Button>
            </form>
            <br/><br/>
                    {this.state.showH && 
