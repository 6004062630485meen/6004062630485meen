...
class BWh2 extends Component {
  ...
  bw2(h, x) {
    this.y = ((3*this.fx(x))-(4*this.fx(x-h))+this.fx(x-(2*h)))/(2*h);
        ...
        <section class="hero is-danger">
          <div className="container">
            <form>
              ...
              <Button ghost onClick={() => this.bw2(parseFloat(this.state.h), parseFloat(this.state.x))}>Submit</Button>
            </form>
            <br/><br/>
                    {this.state.showH && 
